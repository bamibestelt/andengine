...
class Vector2Util {
	...
	public static boolean isLess(final Vector2 pVertexA, final Vector2 pVertexB) {
		...
		final float f = pVertexA.x * pVertexB.y - pVertexB.x * pVertexA.y;
	...
	public static boolean isLonger(final Vector2 pVertexA, final Vector2 pVertexB) {
		...
		final float lenManhattanA = Math.abs(pVertexA.x) + Math.abs(pVertexB.y);
		final float lenManhattanB = Math.abs(pVertexB.x) + Math.abs(pVertexB.y);
		return lenManhattanA > lenManhattanB;
	}
